...
// Accounts that are active in the last 30 days
$active_accounts = $con->query('SELECT * FROM accounts WHERE last_seen > date_sub("' . $date . '", interval 30 day) ORDER BY last_seen DESC')->fetch_all(MYSQLI_ASSOC);
...
<div class="content-title" style="margin-top:40px">
    <div class="title">
        ...
        <div class="txt">
            ...
            <p>Accounts active in the last &lt;30 days.</p>
        </div>
    </div>
</div>
