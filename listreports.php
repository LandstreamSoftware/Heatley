...
<div class="row">
    ...
    <div class="col-sm-4" style="text-align:right;">
        <input class="form-control" id="myInput" type="text" placeholder="Filter reports">
    </div>
</div>-->
...
<table class="table table-striped align-middle">
    ...
    <?php
    $sql = "SELECT * FROM reports where hideReport = '0' ORDER BY iconURL, reportName";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr>
      <td class=\"py-3\" width=\"50px\"><img src=\"".$row["iconURL"]."\" height=\"35px\"\"</td>
      <td><a href=\"/" . $row["reportURL"] . "\">" . $row["reportName"] . "</a></td>
