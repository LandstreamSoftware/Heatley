...
// Lookup the token
$sql = "SELECT * FROM public_invoice_links WHERE token = '$token'";
...
// Fetch the invoice
$sql1 = "SELECT * FROM transactions_view WHERE idtransaction = $transactionid";
$result1 = $con->query($sql1);

if (!$result1) {
    http_response_code(404);
    echo "Invoice data missing.";
    exit;
} else {
...
//Get the invoice
$sql = "SELECT * FROM transactions_view WHERE idtransaction = $transactionid";
$result = $con->query($sql);
//Get the invoice items
$sql1 = "SELECT * FROM invoiceitems_view WHERE invoiceid = $transactionid ORDER BY idinvoiceitem";
$result1 = $con->query($sql1);
