...
$today = date('d M Y');
$where = 'AmountDue>0 AND Type="ACCREC"'; //'DueDate < ' . date("y-m-d",$today) . '';   'AmountDue>0 AND Type="ACCREC"';
$order = 'Contact.Name,Date'; //"InvoiceNumber ASC";
