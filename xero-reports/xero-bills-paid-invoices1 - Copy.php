...
foreach ($connections as $connection) {
    ...
    $invoicesResult = $apiInstance->getInvoices($xeroTenantId, $ifModifiedSince, $finalWhere, $order);
    ...
    foreach ($invoices as $invoice) {
            ...
            echo "<td style=\"vertical-align:middle;\">" . htmlspecialchars($reference) . "</td>";
            ...
            echo "<td style=\"vertical-align:middle;\">" . htmlspecialchars($invoiceNumber) . "</td>";
